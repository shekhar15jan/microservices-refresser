...
public class ProductControllerTest extends AbstractIT {
    ...
    void shouldReturnProductByCode(){
        ...
        assertThat(product.description()).isEqualTo("Despite the tumor-shrinking medical miracle that has bought her a few years, Hazel has never been anything but terminal, her final chapter inscribed upon diagnosis.");
