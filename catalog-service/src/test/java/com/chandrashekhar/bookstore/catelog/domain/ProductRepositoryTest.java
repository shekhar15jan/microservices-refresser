...
import com.chandrashekhar.bookstore.catelog.TestcontainersConfiguration;
...
@DataJpaTest(
 ...
 //@Import(TestcontainersConfiguration.class) //this is not recommended because testcontainerConfiguraiton can contain multiple containers
@Sql("/test-data.sql")
